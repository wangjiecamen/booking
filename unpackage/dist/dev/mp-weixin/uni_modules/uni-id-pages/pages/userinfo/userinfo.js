...
if (!Array) {
  ...
  (_easycom_uni_list_item2 + _easycom_uni_list2 + _easycom_uni_popup_dialog2 + _easycom_uni_popup2 + _easycom_uni_id_pages_bind_mobile2)();
}
...
if (!Math) {
  (_easycom_uni_list_item + _easycom_uni_list + _easycom_uni_popup_dialog + _easycom_uni_popup + _easycom_uni_id_pages_bind_mobile)();
}
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    a: common_vendor.o(($event) => $options.setNickname("")),
    b: common_vendor.p({
      title: "昵称",
      rightText: $options.userInfo.nickname || "未设置",
      link: true
    }),
    c: common_vendor.o($options.bindMobile),
    d: common_vendor.p({
      title: "手机号",
      rightText: $options.userInfo.mobile || "未绑定",
      link: true
    }),
    e: $options.userInfo.email
    ...
    i: common_vendor.sr("dialog", "0be2f605-4"),
    j: common_vendor.p({
      type: "dialog"
    }),
    k: common_vendor.sr("bind-mobile-by-sms", "0be2f605-6"),
    l: common_vendor.o($options.bindMobileSuccess),
    m: $data.showLoginManage
  }, $data.showLoginManage ? common_vendor.e({
    n: $options.userInfo._id
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-0be2f605"], ["__file", "/Users/apple/sub-work/booking/booking/uni_modules/uni-id-pages/pages/userinfo/userinfo.vue"]]);
